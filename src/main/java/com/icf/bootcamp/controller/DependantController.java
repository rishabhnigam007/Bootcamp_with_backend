...
public class DependantController {
	...
	public ResponseEntity<Object> getAllDependants() throws Exception {
		...
		if (DependantsList.size() > 0)
		{
			...
			return new ResponseEntity<Object>(DependantsList.toString(), HttpStatus.OK);
		}
		else
		{
	...
	public Dependants getdependant(@PathVariable Integer id) throws Exception {
	...
	public ResponseEntity<Object> updateDependant(@PathVariable("dependantID") int dependantID,
		...
		if (isDependantExist) {
			...
			return new ResponseEntity<Object>("Dependant updated successfully : \n" + dependant, HttpStatus.OK);
		} else {
