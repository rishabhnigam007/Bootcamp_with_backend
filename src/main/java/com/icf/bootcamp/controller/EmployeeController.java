...
public class EmployeeController {
	 ...
	 * @throws Exception - if employee not present with this particular id in database
	 */

	/* ========== Delete Mapping ========== */

	@DeleteMapping(value = "v1/deleteEmployee/{id}")
	public Employee deleteEmployeeData(@PathVariable String id) throws Exception {
	...
	public ResponseEntity<Object> getAllEmployee() throws Exception {
		...
		if (employeeList.size() > 0)
		{
			...
			return new ResponseEntity<Object>(employeeList.toString(), HttpStatus.OK);
		}
		else
		{
	 ...
	 * @throws Exception - if employee not present for this particular id in database
	 */
	...
	public List<Employee> getemployeeByReportingManager(@PathVariable String reportingManager) throws Exception {
		...
		try {
			...
			throw new NoSuchElementException("Employee does not exist with this Reporting Manager : " + reportingManager);
		}
	 ...
	 * Create a new employee record by passing the employee details in the request
	 * body as JSON pay-load
	 * 
	...
	public ResponseEntity<Object> updateEmployee(@PathVariable("employeeID") int employeeID,@Valid
